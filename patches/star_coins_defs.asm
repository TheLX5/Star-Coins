...
if canreadfile1("../star_coins_defs.asm", 1) == 1
        ...
        !star_coins_page        #= read1(!config_bytes+5)&$7F
        !use_conditional_map16  #= (read1(!config_bytes+5)&$80)>>7
        !star_coin_dynamic      #= (read1(!config_bytes+6)&$80)>>7
        !conditional_map16_flag #= (read1(!config_bytes+6)&$0F)
        !star_coin_ram          #= read3(!config_bytes+7)
...
if !max_star_coins >= 9
        ...
        !points_table           #= !config_bytes+read1(!config_bytes+10)
