...
!config_bytes_pts = $01FFFD             ; The pointer to configuration bytes.
                                        ; If you don't know what you're doing,
                                        ; please keep it as it is.
                                        ; This is an address for the FIRST $10
                                        ; banks and should not be put into
                                        ; freespace.
                                        ; Note that if you change this, you
                                        ; have to also change all instances of
                                        ; this define in other star_coins_defs.asm.
...
!star_coin_points_collected = $09       ; How many points you get from a coin which
                                        ; already has collected. Same values as above.
...
!conditional_map16_flag     = $70       ; The Conditional Map16 flag which keeps
                                        ; track of which Star Coins are collected.
                                        ; Note that it reserves up to 8/16 bits and
                                        ; the value has to end with a zero or eight.
                                        ; This define is not used should Conditional
                                        ; Map16 be disabled.
 
!star_coins_page            = $03       ; Map16 page where the Star Coins blocks
                                        ; are inserted to.
                                        ; This is for Objectool only.
